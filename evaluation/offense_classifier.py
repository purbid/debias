...
opt = {'init_opt': None, 'show_advanced_args': False, 'task': 'interactive', 'download_path': '/mnt/home/liuhaoc1/ParlAI/downloads',
       ...
       'datapath': 'ParlAI/data', 'model': "seq2seq", 'model_file': None,
                                                                                  # '/mnt/home/liuhaoc1/ParlAI/data/models/dialogue_safety/single_turn/model',
       ...
       'train_predict': False, 'cap_num_predictions': 100, 'ignore_bad_candidates': False, 'rank_top_k': -1, 'hiddensize':1024,'embeddingsize': 300,'embedding_size': 300, 'n_layers': 2,
       ...
       'delimiter': '\n', 'gpu': -1, 'no_cuda': True, 'dict_file': None, 'dict_initpath': None, 'dict_language': 'english', 'dict_max_ngram_size': -1,
       ...
       'get_all_metrics': True, 'load_from_pretrained_ranker': False, 'parlai_home': 'ParlAI',
       'override': {'reduction_type': 'first', 'model_file': 'ParlAI/data/models/dialogue_safety/single_turn/model', 'print_scores': False, 'single_turn': True},
